      ...
      $stateProvider
        ...
        .state('index_index_path', {
          ...
          templateUrl: function(params) {
            ...
            return Routes['index_index_path'](params);
          },
          controller: 'IndexCtrl as ctrl',
          resolve: {
            action: ['$stateParams', function ($stateParams) {
        ...
        .state('points_path', {
          ...
          templateUrl: function(params) {
            ...
            return Routes['points_path'](params);
          },
        ...
        .state('new_point_path', {
          ...
          templateUrl: function(params) {
            ...
            return Routes['new_point_path'](params);
          },
          controller: 'PointsCtrl as ctrl',
          resolve: {
            action: ['$stateParams', function ($stateParams) {
        ...
        .state('edit_point_path', {
          ...
          templateUrl: function(params) {
            ...
            return Routes['edit_point_path'](params);
          },
          controller: 'PointsCtrl as ctrl',
          resolve: {
            action: ['$stateParams', function ($stateParams) {
        ...
        .state('point_path', {
          ...
          templateUrl: function(params) {
            ...
            return Routes['point_path'](params);
          },
          controller: 'PointsCtrl as ctrl',
          resolve: {
            action: ['$stateParams', function ($stateParams) {
  ...
  .factory('resourceDecorator', [function () {
    ...
    .factory('Comment', ['$resource', 'resourceDecorator', function ($resource, resourceDecorator) {
      return resourceDecorator($resource('/comments/:id.json', {"id":"@id"}, {
        "new": {
          "method": "GET",
          "url": "/comments/:id/new.json"
        },
        "edit": {
          "method": "GET",
          "url": "/comments/:id/edit.json"
        },
        "update": {
          "method": "PUT"
        },
    ...
    .factory('Point', ['$resource', 'resourceDecorator', function ($resource, resourceDecorator) {
      return resourceDecorator($resource('/points/:id.json', {"id":"@id"}, {
        "new": {
          "method": "GET",
          "url": "/points/:id/new.json"
        },
        "edit": {
          "method": "GET",
          "url": "/points/:id/edit.json"
        },
        "update": {
          "method": "PUT"
        },
