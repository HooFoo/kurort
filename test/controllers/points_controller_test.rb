...
class PointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post points_url, params: { point: { close: @point.close, extra: @point.extra, image: @point.image, lang: @point.lang, lat: @point.lat, lng: @point.lng, name: @point.name, open: @point.open, user_id: @point.user_id } }
    end
  ...
  test "should update point" do
    patch point_url(@point), params: { point: { close: @point.close, extra: @point.extra, image: @point.image, lang: @point.lang, lat: @point.lat, lng: @point.lng, name: @point.name, open: @point.open, user_id: @point.user_id } }
